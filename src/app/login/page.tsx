...
export default function LoginPage() {
  ...
  const inputClass = "w-full px-4 py-3.5 bg-white border border-stone-200 text-stone-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 placeholder-stone-400";
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="space-y-5">
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-stone-700 mb-1.5">이메일</label>
                  <input
                    type="email"
                    id="email"
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    <label htmlFor="password" className="text-sm font-medium text-stone-700">비밀번호</label>
                    <Link href="/forgot-password" className="text-xs font-medium text-secondary hover:text-[#8d6945] transition-colors">
                      비밀번호를 잊으셨나요?
                    </Link>
                  </div>
                  <input
                    type="password"
                    id="password"
                    className={`${inputClass} ${errors.password ? 'border-red-500 ring-red-100' : ''}`}
                    placeholder="••••••••"
